        ...
        if (Util.isInteger(productId)) {
            ...
            try {
                ...
                if (product.getStatus().getValue().equals("Active")) {
                    ...
                    product.getAdmin().setEmail(null); //requset karana keneta yawwata wadac na
                    product.getAdmin().setPassword(null);
                    product.getAdmin().setId(-1);
                    ...
                    for (Product pr : productList) {
                        ...
                        pr.getAdmin().setEmail(null);
                        pr.getAdmin().setPassword(null);
                        pr.getAdmin().setId(-1);
